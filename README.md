...
Nesta versão, o painel das vans é visual dentro do próprio app: o administrador aperta **Atualizar vans** e o mapa reposiciona os alfinetes de todas as vans com viagem em andamento ou última rota conhecida. Sem chave, o app usa Leaflet/OpenStreetMap. Se o administrador preencher uma chave do Google Maps, o mesmo painel passa a usar Google Maps embutido, sem precisar abrir link externo.

O botão **Atualizar vans** recalcula as posições e atualiza todos os alfinetes no mapa. Ele calcula a localização assim:
...
- Apertar **Atualizar vans** e conferir todos os alfinetes no mapa visual do painel administrativo.
- Conferir se os alfinetes mudam quando há GPS real ou quando a estimativa por tempo/rota avança.
